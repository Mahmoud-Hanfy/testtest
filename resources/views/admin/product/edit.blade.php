...
@section('content')
    <center>
        ...
        <form style="color: white;width: 40%;border: 3px solid saddlebrown;border-radius: 10px"  method="post" action="{{route('admin.products.update',$product->id)}}" class="form-control-lg " enctype="multipart/form-data" >
            {{csrf_field()}}
