            ...
            <ul class="sidebar-menu">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                      <li class="active"><a href="{{route('admin.products.show')}}"><i class="fa fa-circle-o"></i> Show</a></li>
                        <li><a href="{{route('admin.products.create')}}"><i class="fa fa-circle-o"></i> Create</a></li>
                        <li><a href="{{route('admin.products.index')}}"><i class="fa fa-circle-o"></i> Index</a></li>
                    </ul>
                </li>
                <li class="active treeview">
                    <a href="#">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        <li class="active"><a href="{{route('admin.category.show')}}"><i class="fa fa-circle-o"></i> Show</a></li>
